---
title: "Fixed Cells 101515.C3 ESCs Analysis (Batch50 and 51)"
...
###Match fixed_cellsbetween the three colors based on proximity
```{r}
...
```
```{r}
fixed_cell_101515_C3_Batch50 <- fixed_cells
```

```{r}
datdir <- "/Users/Jeff/Desktop/07_07_2017_Batch51/Stacks/0_spots/"
batch <- "Batch51_02"
```
...
```{r}
fixed_cell_101515_C3_Batch51 <- fixed_cells
fixed_cells_total <- rbind(fixed_cell_101515_C3_Batch50, fixed_cell_101515_C3_Batch51)
den1 <- density(fixed_cells_total$`Corrected XY_Distance (um)`)
den2 <- density(Sox2_data_unsync_20sec[Sox2_data_unsync_20sec$Cell_Line == "101515.C3_ESC", "Corrected XY_Distance (um)"])

plot(den1$x, den1$y, type="l", ylim=c(0,6), col="black", main="XY_Distance")
lines(den2$x, den2$y, type="l", ylim=c(0,6), col="red")

den1 <- density(fixed_cells_total$`Corrected XYZ_Distance (um)`)
den2 <- density(Sox2_data_unsync_20sec[Sox2_data_unsync_20sec$Cell_Line == "101515.C3_ESC", "Corrected XYZ_Distance (um)"])

plot(den1$x, den1$y, type="l", ylim=c(0,6), col="black", main="XYZ_Distance")
lines(den2$x, den2$y, type="l", ylim=c(0,6), col="red")
```
