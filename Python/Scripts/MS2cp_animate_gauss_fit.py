...
parser.add_argument('-d', '--data', help='table that contains tracking data.  Should be tab-delimited for columns Image\tX Value (pixel)\tY Value (pixel)\tZ Value (pixel)\tT Value (sec)');
