...
parser.add_argument('-d', '--data', help='table that contains tracking data.  Should be tab-delimited for columns C1_Image\tC1_X Value (pixel)\tC1_Y Value (pixel)\tC1_T Value (pixel)\tC1_T Value (sec)');
