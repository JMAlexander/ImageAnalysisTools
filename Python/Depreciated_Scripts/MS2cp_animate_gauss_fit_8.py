...
parser.add_argument('-s', '--sigma', type=float, default=1.5, help='minimum value of Gaussian sigma');
...
with PdfPages('MS2_expression_plots.pdf') as pdf:
    ...
    for i in image_list:
        ...
        scat = ax.scatter([center_x], [center_y], marker='o', facecolors = 'none', edgecolors='r', s=25, linewidth=(0.5 * ((calc_amp + calc_offset) / calc_offset)));
